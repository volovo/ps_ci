...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "Không có dữ liệu để hiển thị" )
		{
	...
	function _fnGetCellData( oSettings, iRow, iCol, sSpecific )
	{
		...
		if ( sData === undefined )
		{
			...
			{
				_fnLog( oSettings, 0, "Yêu cầu tham số chưa biết "+
	...
	function _fnPageChange ( settings, action, redraw )
	{
		...
		{
			_fnLog( settings, 0, "Hành động phân trang chưa biết: "+action, 5 );
		}
	...
	function _fnScrollDraw ( settings )
	{
		...
		if ( table.outerWidth() < sanityWidth )
		{
			...
			if ( scrollX === "" || scrollXInner !== "" ) {
				_fnLog( settings, 1, 'Possible cột không thẳng hàng', 6 );
			}
		}
		else
		{
	...
	function _fnLog( settings, level, msg, tn )
	{
		...
		if ( tn ) {
			msg += '. Để xem thêm thông tin về lỗi xem tại: '+
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": "Không tồn tại dữ liệu trong bảng",
			 ...
			 *    } );
			 */
			"sInfo": "Hiển thị từ _START_ đến _END_ trong tổng _TOTAL_ hàng",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Hiển thị từ 0 đến 0 trong tổng 0 hàng",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(lọc từ tổng số _MAX_ hàng)",
			 ...
			 *    } );
			 */
			"sLengthMenu": "Hiển thị _MENU_ hàng trên 1 trang",
